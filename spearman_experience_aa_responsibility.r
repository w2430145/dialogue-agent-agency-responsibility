...
#
# install.packages("logspline") # This package might be needed for some functions, but typically installed separately.
...
# -----------------------------------------------------------------------------
aa_responsibility <- c(5, 6, 6, 6, 5, 7, 6, 5, 7, 6, 6, 6, 6, 3, 7, 2, 6, 7, 6, 7, 7, 5)
...
print(paste("Bayes Factor (BF10, exact model) for your data (Spearman correlation):", round(bf10_spearman_exact, 3)))
